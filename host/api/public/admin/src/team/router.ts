...
export class TeamRouter extends Router {
  ...
  protected routes(app: Hono): void {
    app.route("/role", RolesRouter.create(this.#adminOnly));
    app.route("/role", RoleRouter.create(this.#adminOnly));
    app.route("/", MembersRouter.create(this.#adminOnly));
    app.route("/", MemberRouter.create(this.#adminOnly));
  }
}
