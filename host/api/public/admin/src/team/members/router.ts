...
import { AdminsPaginationEndpoint } from "./pagination.ts";

export class MembersRouter extends Router {
  constructor(adminOnly: MiddlewareHandler) {
    super(adminOnly);
  }

  protected routes(app: Hono): void {
    app.get("/", permission("team:read"), () => AdminsPaginationEndpoint.handle());
  }
}
