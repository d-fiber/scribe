...
import { app as pushRouter } from "./push/router.ts";

class Messaging extends Router {
...
export const app = Messaging.create();

if (import.meta.main) serveFunction(app, "messaging");
