...
import {
  ...
  type PushResult,
  PushResultSchema,
} from "@scribe/sdk/gen/scribe/host/core/runtime/event_driven/queue/protocol/queue_pb.ts";
import {
  type EmitResult,
  EmitResultSchema,
  type Event,
} from "@scribe/sdk/gen/scribe/host/core/runtime/event_driven/hook/protocol/hook_pb.ts";
import { Time } from "@scribe/core/contracts/common/time.ts";
import { hookRegistry } from "@scribe/core/runtime/event_driven/hook/mod.ts";
import { QueueProducer } from "@scribe/core/runtime/event_driven/queue/core/producer.ts";
import { queueRegistry } from "@scribe/core/runtime/event_driven/queue/mod.ts";
