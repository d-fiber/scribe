...
import { anonHeaders, type AuthError, authUrl, type GoTrueSessionResponse, requestAuth, requestAuthVoid } from "@scribe/host/dependencies/security/auth/src/_core/gotrue/transport.ts";
