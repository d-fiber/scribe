...
type RPCB<T extends object> = ReturnType<PostgrestClient["rpc"]> & { _row: T };
...
function rpc<T extends object>(
  ...
  return db.rpc(fn, args) as RPCB<T>;
}
...
export class TablesBase {
  ...
  protected get db(): PostgrestClient {
    if (this.#client === null) {
      this.#client = typeof this.#source === "function"
        ? this.#source()
        : this.#source;
    }
    return this.#client;
  ...
  rpc<R extends object = object>(fn: string, args?: Record<string, unknown>) {
