...
import { ensureTopology } from "@scribe/core/runtime/event_driven/queue/core/topology/ready.ts";
import type { DrainResult } from "@scribe/core/runtime/event_driven/queue/contract.ts";
