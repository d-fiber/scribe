...
//
// Generated from scribe/packages/foundation/protocol/database.proto.
...
const Filter$json = {
  ...
  '2': [
    {'1': 'column', '3': 1, '4': 1, '5': 9, '10': 'column'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.scribe.runtime.database.v1.FilterOperator',
      '10': 'operator'
    },
    {
      '1': 'value',
...
final $typed_data.Uint8List filterDescriptor = $convert.base64Decode(
    ...
    'JpYmUucnVudGltZS5kYXRhYmFzZS52MS5GaWx0ZXJPcGVyYXRvclIIb3BlcmF0b3ISJQoFdmFs'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.scribe.runtime.database.v1.Filter',
      '10': 'filters'
    },
    {
      '1': 'groups',
      ...
      '4': 3,
      '5': 11,
      '6': '.scribe.runtime.database.v1.FilterGroup',
      '10': 'groups'
    },
...
final $typed_data.Uint8List filterGroupDescriptor = $convert.base64Decode(
    'CgtGaWx0ZXJHcm91cBI8CgdmaWx0ZXJzGAEgAygLMiIuc2NyaWJlLnJ1bnRpbWUuZGF0YWJhc2'
    'UudjEuRmlsdGVyUgdmaWx0ZXJzEj8KBmdyb3VwcxgCIAMoCzInLnNjcmliZS5ydW50aW1lLmRh'
...
const Query$json = {
  ...
  '2': [
    {'1': 'table', '3': 1, '4': 1, '5': 9, '10': 'table'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.scribe.runtime.database.v1.Operation',
      '10': 'operation'
    },
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.scribe.runtime.database.v1.Order',
      '10': 'order'
    },
    {
      '1': 'range',
      ...
      '4': 1,
      '5': 11,
      '6': '.scribe.runtime.database.v1.Range',
      '10': 'range'
    },
...
final $typed_data.Uint8List queryDescriptor = $convert.base64Decode(
    ...
    'JlLnJ1bnRpbWUuZGF0YWJhc2UudjEuT3BlcmF0aW9uUglvcGVyYXRpb24SFgoGc2VsZWN0GAMg'
    'AygJUgZzZWxlY3QSPQoFd2hlcmUYBCABKAsyJy5zY3JpYmUucnVudGltZS5kYXRhYmFzZS52MS'
    '5GaWx0ZXJHcm91cFIFd2hlcmUSNwoFb3JkZXIYBSADKAsyIS5zY3JpYmUucnVudGltZS5kYXRh'
    'YmFzZS52MS5PcmRlclIFb3JkZXISNwoFcmFuZ2UYBiABKAsyIS5zY3JpYmUucnVudGltZS5kYX'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.scribe.runtime.database.v1.Query',
      '10': 'queries'
    },
  ],
};
...
final $typed_data.Uint8List queryBatchDescriptor = $convert.base64Decode(
    'CgpRdWVyeUJhdGNoEjsKB3F1ZXJpZXMYASADKAsyIS5zY3JpYmUucnVudGltZS5kYXRhYmFzZS'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.scribe.runtime.database.v1.QueryResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List queryResultBatchDescriptor = $convert.base64Decode(
    'ChBRdWVyeVJlc3VsdEJhdGNoEkEKB3Jlc3VsdHMYASADKAsyJy5zY3JpYmUucnVudGltZS5kYX'
...
const $core.Map<$core.String, $core.dynamic> DatabaseServiceBase$json = {
  ...
  '2': [
    {
      '1': 'Execute',
      '2': '.scribe.runtime.database.v1.Query',
      '3': '.scribe.runtime.database.v1.QueryResult'
    },
    {
      '1': 'ExecuteBatch',
      '2': '.scribe.runtime.database.v1.QueryBatch',
      '3': '.scribe.runtime.database.v1.QueryResultBatch'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.scribe.runtime.database.v1.Query': Query$json,
  '.scribe.runtime.database.v1.FilterGroup': FilterGroup$json,
  '.scribe.runtime.database.v1.Filter': Filter$json,
  '.scribe.v1.Json': $0.Json$json,
  '.scribe.runtime.database.v1.Order': Order$json,
  '.scribe.runtime.database.v1.Range': Range$json,
  '.scribe.runtime.database.v1.QueryResult': QueryResult$json,
  '.scribe.v1.Failure': $0.Failure$json,
  '.scribe.runtime.database.v1.QueryBatch': QueryBatch$json,
  '.scribe.runtime.database.v1.QueryResultBatch': QueryResultBatch$json,
};
...
final $typed_data.Uint8List databaseServiceDescriptor = $convert.base64Decode(
    'CghEYXRhYmFzZRJVCgdFeGVjdXRlEiEuc2NyaWJlLnJ1bnRpbWUuZGF0YWJhc2UudjEuUXVlcn'
    'kaJy5zY3JpYmUucnVudGltZS5kYXRhYmFzZS52MS5RdWVyeVJlc3VsdBJkCgxFeGVjdXRlQmF0'
    'Y2gSJi5zY3JpYmUucnVudGltZS5kYXRhYmFzZS52MS5RdWVyeUJhdGNoGiwuc2NyaWJlLnJ1bn'
    'RpbWUuZGF0YWJhc2UudjEuUXVlcnlSZXN1bHRCYXRjaA==');
