...
//
// Generated from scribe/host/pkg/packages/foundation/protocol/valkery/valkery.proto.
...
class ValkeryKey extends $pb.GeneratedMessage {
  factory ValkeryKey({
  ...
  factory ValkeryKey.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ValkeryKey.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ValkeryKey',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'scribe.runtime.valkery.v1'),
  ...
  ValkeryKey clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ValkeryKey copyWith(void Function(ValkeryKey) updates) =>
      super.copyWith((message) => updates(message as ValkeryKey)) as ValkeryKey;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ValkeryKey create() => ValkeryKey._();
  @$core.override
  ValkeryKey createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ValkeryKey getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ValkeryKey>(create);
  static ValkeryKey? _defaultInstance;
...
class GetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'scribe.runtime.valkery.v1'),
      createEmptyInstance: create)
    ..aOM<ValkeryKey>(1, _omitFieldNames ? '' : 'key',
        subBuilder: ValkeryKey.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  ValkeryKey get key => $_getN(0);
  @$pb.TagNumber(1)
  set key(ValkeryKey value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearKey() => $_clearField(1);
  @$pb.TagNumber(1)
  ValkeryKey ensureKey() => $_ensure(0);
}
