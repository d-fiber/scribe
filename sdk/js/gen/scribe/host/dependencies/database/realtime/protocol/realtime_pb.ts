...
// @generated from file scribe/host/dependencies/database/realtime/protocol/realtime.proto (package scribe.clients.realtime.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file scribe/host/dependencies/database/realtime/protocol/realtime.proto.
 */
export const file_scribe_host_dependencies_database_realtime_protocol_realtime: GenFile = /*@__PURE__*/
  fileDesc("", [file_scribe_protocol_common, file_scribe_protocol_broadcast]);
...
export const TargetSchema: GenMessage<Target, {jsonType: TargetJson}> = /*@__PURE__*/
  messageDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 0);
...
export const BroadcastRequestSchema: GenMessage<BroadcastRequest, {jsonType: BroadcastRequestJson}> = /*@__PURE__*/
  messageDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 1);
...
export const BroadcastResultSchema: GenMessage<BroadcastResult, {jsonType: BroadcastResultJson}> = /*@__PURE__*/
  messageDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 2);
...
export const TopicMembershipRequestSchema: GenMessage<TopicMembershipRequest, {jsonType: TopicMembershipRequestJson}> = /*@__PURE__*/
  messageDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 3);
...
export const TopicMembershipResultSchema: GenMessage<TopicMembershipResult, {jsonType: TopicMembershipResultJson}> = /*@__PURE__*/
  messageDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 4);
...
export const Realtime: GenService<{
  ...
  serviceDesc(file_scribe_host_dependencies_database_realtime_protocol_realtime, 0);
